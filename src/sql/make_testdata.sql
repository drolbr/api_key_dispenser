...
insert into keys (created_ref, service_ref, user_ref, data) values (1, 1, 7, 'abcd0000');
update keys set revoked_ref = 2 where created_ref = 1;
insert into keys (created_ref, service_ref, user_ref, data) values (3, 1, 7, 'abcd1111');
